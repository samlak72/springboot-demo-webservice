...
nohup java -jar \
      -Dspring.config.location=classpath:/application.yml,classpath:/application-real.yml,/home/ec2-user/app/application-auth.yml,/home/ec2-user/app/application-real-db.yml
